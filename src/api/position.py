    ...
    return {
        ...
        "dr_data": {
            ...
            "k1": {
                ...
                "settlement_price": float(row.get("k1_settlement_price", 0)) if row.get("k1_settlement_price") not in [None, "", "0.0", 0] else None,
            },
            "k2": {
                "instrument": str(row.get("inst_k2", "")),
                "price_t0": float(row.get("dr_k2_price", 0)),
                "iv": float(row.get("k2_iv", 0)),
                "settlement_price": float(row.get("k2_settlement_price", 0)) if row.get("k2_settlement_price") not in [None, "", "0.0", 0] else None,
            },
            "risk": {
