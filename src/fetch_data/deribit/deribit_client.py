    ...
    async def get_db_context(
        ...
        try:
            ...
            return DeribitMarketContext(
                ...
                k1_ask_1_usd=k1_asks[0] if len(k1_asks) >= 1 else [],
                k1_ask_2_usd=k1_asks[1] if len(k1_asks) >= 2 else [],
                k1_ask_3_usd=k1_asks[2] if len(k1_asks) >= 3 else [],
                k2_ask_1_usd=k2_asks[0] if len(k2_asks) >= 1 else [],
                k2_ask_2_usd=k2_asks[1] if len(k2_asks) >= 2 else [],
                k2_ask_3_usd=k2_asks[2] if len(k2_asks) >= 3 else [],

                k1_bid_1_usd=k1_bids[0] if len(k1_bids) >= 1 else [],
                k1_bid_2_usd=k1_bids[1] if len(k1_bids) >= 2 else [],
                k1_bid_3_usd=k1_bids[2] if len(k1_bids) >= 3 else [],
                k2_bid_1_usd=k2_bids[0] if len(k2_bids) >= 1 else [],
