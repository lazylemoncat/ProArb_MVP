...
async def maintain_ev(ev_path: str, signal_id: str, position_df: DataFrame):
    ...
    ev_data = EVResponse(
        ...
        pm_shares=pos_row["pm_shares"],
        pm_slippage_usd=pos_row["pm_slippage_usd"],
        dr_contracts=pos_row["contracts"],
        dr_k1_price=pos_row["dr_k1_price"],
        dr_k2_price=pos_row["dr_k2_price"],
        ...
        ev_gross_usd=pos_row["ev_gross_usd"],
        ev_theta_adj_usd=pos_row["ev_theta_adj_usd"],
        ev_model_usd=pos_row["ev_model_usd"],
        roi_model_pct=pos_row["roi_model_pct"],
    )
